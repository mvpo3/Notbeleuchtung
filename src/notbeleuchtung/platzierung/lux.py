...
höhe). `I` (cd) ist vereinfacht isotrop angenommen und als Parameter übergeben — der
exakte Wert kommt später aus der Hersteller-Photometrie (IES/LDT). Kein Anspruch auf
Fotometrie-Genauigkeit; Zweck ist der Struktur-Nachweis (Mindestwert + Ud).
"""
...
def lux_raster(
    ...
    *,
    ...
    for lx, ly in leuchten:
        ...
        e += i_cd * cos_theta**3 / (montagehoehe_m**2)
